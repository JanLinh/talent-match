...
const QUESTIONS = {
  iq: [
    { id: 1, type: 'iq', question: 'Máš odhadnout, kolik tenisových míčků se vejde do standardního osobního auta. Jak k tomu přistoupíš?', options: ['Střelím odhad podle toho, jak velké se mi auto zdá.', 'Vyhledám objem interiéru v litrech a vydělím ho objemem jednoho míčku.', 'Řeknu, že je to nemožné určit bez přesných přístrojů.', 'Zeptám se někoho, kdo takový pokus viděl na internetu.'], correct: 1 },
    { id: 2, type: 'iq', question: 'Graf ukazuje silnou souvislost mezi počtem prodaných zmrzlin a počtem požárů. Co si o tom pomyslíš?', options: ['Zmrzlina způsobuje nepozornost vedoucí k požárům.', 'Prodejci zmrzliny by měli být proškoleni v požární ochraně.', 'Hledám třetí faktor (např. horké počasí), který ovlivňuje obě proměnné.', 'Je to důkaz, že tyto trhy jsou na sobě závislé.'], correct: 2 },
    { id: 3, type: 'iq', question: 'V kuchyňce jsou tři konvice. Konvice A je vždy plná horké vody, B a C jsou skoro vždy prázdné. Chceš si co nejrychleji zalít čaj. Co uděláš jako první?', options: ['Použiji konvici A – nejefektivnější cesta.', 'Prozkoumám konvici A – proč ji nikdo nepoužívá? Možná je v ní odvápňovač.', 'Doleji vodu do konvice B – lidé ji preferují, raději čerstvě uvaří.', 'Zeptám se kolegy: Funguje ta áčková konvice?'], correct: 1 },
    { id: 4, type: 'iq', question: 'Skládáte se na společné svačiny. Zjistíte, že peníze v pokladničce končí o dva dny dříve než obvykle. Jak určíš příčinu?', options: ['Zavedu knihu svačin – každý zapisuje, co si vzal.', 'Udělám revizi cen – podívám se na účtenky, zda dodavatel nezdražil.', 'Navrhnu zvýšit příspěvek – inflace funguje, prostě vybereme víc.', 'Počkám, co udělá kolega – přidám se k většinovému názoru.'], correct: 1 },
    { id: 5, type: 'iq', question: 'Objednáváš pizzu pro 20 lidí: čtvrtina jsou vegetariáni, 3 drží bezlepkovou dietu, zbytek jí vše. Jakou logiku zvolíš?', options: ['Od každého druhu něco – pestrý výběr pro všechny.', '3 bezlepkové, 5 vegetariánských, zbytek masové – na opačné straně stolu.', '20x Margherita – jí ji skoro každý a ušetřím čas.', 'Pošlu hromadný e-mail, kde si každý vybere příchuť.'], correct: 1 },
    { id: 6, type: 'iq', question: 'Doplňte chybějící prvek: A1, C3, F6, J10, ...?', options: ['L12', 'N14', 'O15', 'P16'], correct: 2 },
    { id: 7, type: 'iq', question: 'Zboží bylo zlevněno o 20 % a poté nová cena zvýšena o 25 %. Jaká je výsledná cena oproti původní?', options: ['Je o 5 % vyšší.', 'Je o 5 % nižší.', 'Je přesně stejná jako původní.', 'Je o 2 % nižší.'], correct: 2 },
    { id: 8, type: 'iq', question: 'Pokud slovo ALGORITMUS zakódujeme jako BMHPSJUMTU, jak zakódujeme slovo DATA?', options: ['EBUB', 'CZSZ', 'CBUB', 'EZSZ'], correct: 0 },
    { id: 9, type: 'iq', question: 'Pokud 4 stroje vyrobí 4 výrobky za 4 minuty, za kolik minut vyrobí 100 strojů 100 výrobků?', options: ['100 minut', '25 minut', '4 minuty', '1 minuta'], correct: 2 },
    { id: 10, type: 'iq', question: 'Doplňte řadu: 1, 1, 2, 3, 5, 8, 13, ...?', options: ['18', '20', '21', '25'], correct: 2 }
  ],
  personality: [
    { id: 1, type: 'big5', trait: 'conscientiousness', question: 'Když dostanu nový úkol bez detailního zadání, obvykle...', options: ['začnu hned pracovat a řešení hledám samostatně v průběhu.', 'nejprve si vyhledám dostupné informace nebo příklady a pak se pustím do práce.', 'nejprve si ujasním postup a potvrdím si ho s nadřízeným.', 'poprosím o doplnění zadání a přesné instrukce, jak postupovat.'], likertValues: [4, 3, 2, 1] },
    { id: 2, type: 'big5', trait: 'extraversion', question: 'Když pracuji v týmu, obvykle...', options: ['mluvím hlavně tehdy, když jsem osloven/a.', 'aktivně přispívám svými nápady do diskuse.', 'raději více poslouchám a přemýšlím nad diskusí.', 'přirozeně přebírám iniciativu v diskusi.'], likertValues: [2, 3, 1, 4] },
    { id: 3, type: 'big5', trait: 'openness', question: 'Pokud dojde k nečekané změně v práci, obvykle...', options: ['se snažím rychle přizpůsobit a najít nové řešení.', 'raději bych pokračoval/a podle původního plánu.', 'potřebuji chvíli, než si na změnu zvyknu.', 'změny beru jako příležitost naučit se něco nového.'], likertValues: [3, 1, 2, 4] },
    { id: 4, type: 'big5', trait: 'openness', question: 'Při řešení složitého problému obvykle preferuji...', options: ['využít postupy, které se už v minulosti osvědčily.', 'hledat kreativní nebo netradiční řešení.', 'požádat o radu zkušenější osobu.', 'kombinovat známé postupy s novými nápady.'], likertValues: [2, 4, 1, 3] },
    { id: 5, type: 'big5', trait: 'agreeableness', question: 'Když pracuji s lidmi, kteří se mnou nesouhlasí, obvykle...', options: ['se snažím pochopit jejich pohled na věc.', 'hledám kompromisní řešení.', 'raději se do diskuse příliš nepouštím.', 'snažím se jasně obhájit svůj názor.'], likertValues: [4, 3, 1, 2] },
    { id: 6, type: 'big5', trait: 'extraversion', question: 'Na pracovních nebo společenských setkáních s novými lidmi obvykle...', options: ['spíše pozoruji a zapojuji se až později.', 'bez větších problémů konversuji, když mě někdo osloví.', 'snadno navazuji konverzaci s ostatními.', 'preferuji rozhovory v menších skupinách.'], likertValues: [1, 2, 4, 3] },
    { id: 7, type: 'big5', trait: 'agreeableness', question: 'Když mě kolega požádá o pomoc, obvykle...', options: ['pomohu, pokud se to týká mé práce.', 'snažím se pomoci hned i přesto, že toho mám sám/sama dost.', 'pomohu, pokud mi to pracovní vytížení dovolí.', 'preferuji, aby si každý řešil své úkoly samostatně.'], likertValues: [2, 4, 3, 1] },
    { id: 8, type: 'big5', trait: 'conscientiousness', question: 'Ve své práci obvykle...', options: ['mám jasně nastavený systém a udržuji si přehled ve všech úkolech.', 'většinou si věci organizuji, ale občas pracuji flexibilně podle situace.', 'organizaci řeším spíše průběžně podle aktuální potřeby.', 'pracuji spíše spontánně a systém není pro mě zásadní.'], likertValues: [4, 3, 2, 1] },
    { id: 9, type: 'big5', trait: 'neuroticism', question: 'Kritickou zpětnou vazbu na svou práci dokážu přijmout konstruktivně a využít ji ke zlepšení.' },
    { id: 10, type: 'big5', trait: 'conscientiousness', question: 'Pracovní úkoly si obvykle organizuji tak, abych je dokončil/a s dostatečným předstihem před termínem.' },
    { id: 11, type: 'big5', trait: 'neuroticism', question: 'Při důležitých rozhodnutích dokážu zachovat klid a nejprve si vše dobře promyslet.' },
    { id: 12, type: 'big5', trait: 'neuroticism', question: 'Dokážu zachovat klid a soustředění i při práci pod tlakem.' },
    { id: 13, type: 'big5', trait: 'openness', question: 'Ve své práci preferuji úkoly, které mi umožňují přicházet s novými nápady a hledat vlastní řešení.' },
    { id: 14, type: 'big5', trait: 'agreeableness', question: 'V týmové práci se snažím podporovat spolupráci a dobrou atmosféru mezi kolegy.' },
    { id: 15, type: 'big5', trait: 'extraversion', question: 'Komunikace s novými lidmi nebo klienty mi obvykle nedělá problém.' }
  ],
  psycho: [
    { id: 1, type: 'integrity', question: 'Všimneš si chyby v procesu, která zpomaluje celý tým. Není to tvoje odpovědnost a nikdo jiný to neřeší. Co uděláš?', options: [{ text: 'Ignoruju to, není to moje role.', score: 0 }, { text: 'Zmíním to nadřízenému a dál to neřeším.', score: 40 }, { text: 'Navrhnu řešení a zkusím ho probrat s týmem.', score: 80 }, { text: 'Začnu to aktivně řešit a dotáhnu změnu s ostatními.', score: 100 }] },
    { id: 2, type: 'integrity', question: 'Kolega opakovaně nedodává svou část práce včas, což ohrožuje projekt. Co uděláš?', options: [{ text: 'Udělám jeho práci za něj, aby byl klid.', score: 20 }, { text: 'Postěžuji si ostatním kolegům.', score: 10 }, { text: 'Otevřeně to s ním proberem a hledám řešení.', score: 80 }, { text: 'Proberem to s ním a pokud se to nezlepší, zapojím vedoucího.', score: 100 }] },
    { id: 3, type: 'integrity', question: 'Dostaneš kritický feedback na svou práci, se kterým nesouhlasíš. Co uděláš?', options: [{ text: 'Ignoruju ho.', score: 0 }, { text: 'Vysvětlím, proč je špatný.', score: 20 }, { text: 'Zamyslím se nad ním a vyžádám si konkrétní příklady.', score: 80 }, { text: 'Aktivně ho zapracuji a ověřím si zlepšení.', score: 100 }] },
    { id: 4, type: 'integrity', question: 'Manažer tě požádá, abys trochu upravil čísla, aby report vypadal lépe. Co uděláš?', options: [{ text: 'Udělám to, je to jeho odpovědnost.', score: 0 }, { text: 'Udělám to, ale nejsem s tím v pohodě.', score: 10 }, { text: 'Upozorním na problém a odmítnu.', score: 80 }, { text: 'Odmítnu a navrhnu transparentní alternativu.', score: 100 }] },
    { id: 5, type: 'integrity', question: 'Projekt, na kterém jsi pracoval týdny, se náhle ruší. Co uděláš?', options: [{ text: 'Jsem frustrovaný/á a ztrácím motivaci.', score: 10 }, { text: 'Přijmu to, ale bez většího zájmu.', score: 40 }, { text: 'Rychle se přeorientuji na nové zadání.', score: 80 }, { text: 'Aktivně hledám, jak využít už odvedenou práci jinde.', score: 100 }] },
    { id: 6, type: 'integrity', question: 'Vidíš, že rozhodnutí týmu směřuje špatným směrem, ale jsi v menšině. Co uděláš?', options: [{ text: 'Nic neřeknu.', score: 0 }, { text: 'Řeknu to jednou a dál to neřeším.', score: 40 }, { text: 'Argumentuji svůj pohled.', score: 70 }, { text: 'Aktivně diskutuji a hledám nejlepší řešení s týmem.', score: 100 }] },
    { id: 7, type: 'integrity', question: 'Zákazník si stěžuje na problém, který jsi nezpůsobil. Co uděláš?', options: [{ text: 'Odkážu ho jinam.', score: 10 }, { text: 'Vysvětlím, že to není moje chyba.', score: 20 }, { text: 'Pomohu mu problém vyřešit.', score: 80 }, { text: 'Vyřeším problém a hledám způsob, jak mu předejít.', score: 100 }] },
    { id: 8, type: 'integrity', question: 'Máš tři urgentní úkoly s podobným deadlinem. Co uděláš?', options: [{ text: 'Dělám je postupně, jak přišly.', score: 20 }, { text: 'Vyberu si ten nejjednodušší.', score: 10 }, { text: 'Prioritizuji podle dopadu.', score: 80 }, { text: 'Prioritizuji, komunikuji očekávání a případně přerozdělím práci.', score: 100 }] },
    { id: 9, type: 'integrity', question: 'Uděláš chybu, která způsobí problém v projektu. Co uděláš?', options: [{ text: 'Snažím se ji skrýt.', score: 0 }, { text: 'Přiznám ji, ale bez další akce.', score: 30 }, { text: 'Přiznám ji a opravím.', score: 80 }, { text: 'Přiznám ji, opravím a nastavím prevenci do budoucna.', score: 100 }] },
    { id: 10, type: 'integrity', question: 'Dostaneš úkol, který vyžaduje dovednost, kterou nemáš. Co uděláš?', options: [{ text: 'Odmítnu ho.', score: 0 }, { text: 'Zkusím to bez přípravy.', score: 20 }, { text: 'Naučím se základy.', score: 70 }, { text: 'Aktivně se vzdělám a požádám o pomoc, abych to zvládl/a dobře.', score: 100 }] },
    { id: 11, type: 'integrity', question: 'Blíží se deadline a víš, že pokud práci odevzdáš včas, bude obsahovat chyby. Co uděláš?', options: [{ text: 'Odevzdám to tak, jak to je.', score: 10 }, { text: 'Odevzdám to a chyby zmíním až potom.', score: 20 }, { text: 'Upozorním na riziko a navrhnu řešení.', score: 80 }, { text: 'Aktivně vyjednám prioritu mezi kvalitou a termínem a upravím plán.', score: 100 }] },
    { id: 12, type: 'integrity', question: 'Dostaneš úkol s velmi vágním zadáním. Co uděláš?', options: [{ text: 'Počkám, až někdo upřesní zadání.', score: 10 }, { text: 'Udělám to podle sebe bez ověření.', score: 20 }, { text: 'Doptám se na klíčové věci.', score: 80 }, { text: 'Navrhnu konkrétní směr a nechám si ho rychle potvrdit.', score: 100 }] },
    { id: 13, type: 'integrity', question: 'Vidíš, že jeden kolega dostává uznání za práci, na které ses významně podílel. Co uděláš?', options: [{ text: 'Neřeším to.', score: 10 }, { text: 'Postěžuji si kolegům.', score: 0 }, { text: 'Otevřu to s daným kolegou.', score: 70 }, { text: 'Otevřu to konstruktivně a nastavím jasnější pravidla do budoucna.', score: 100 }] },
    { id: 14, type: 'integrity', question: 'Tvůj nadřízený tě příliš kontroluje a zasahuje do detailů. Co uděláš?', options: [{ text: 'Frustruje mě to, ale nic neřeknu.', score: 10 }, { text: 'Omezím komunikaci na minimum.', score: 0 }, { text: 'Otevřeně to s ním proberem.', score: 70 }, { text: 'Navrhnu konkrétní způsob spolupráce a reporting, který sníží potřebu kontroly.', score: 100 }] },
    { id: 15, type: 'integrity', question: 'Kolega udělá chybu, která zatím není viditelná, ale může způsobit problém později. Co uděláš?', options: [{ text: 'Neřeším to.', score: 0 }, { text: 'Opravím to bez jeho vědomí.', score: 30 }, { text: 'Upozorním ho na to.', score: 70 }, { text: 'Upozorním ho a pomohu nastavit prevenci.', score: 100 }] },
    { id: 16, type: 'integrity', question: 'Máš víc práce, než je reálně zvládnutelné. Co uděláš?', options: [{ text: 'Pracuji déle a doufám, že to zvládnu.', score: 20 }, { text: 'Vyberu si, co chci dělat.', score: 10 }, { text: 'Prioritizuji a něco odložím.', score: 70 }, { text: 'Prioritizuji, komunikuji kapacitu a hledám řešení s týmem.', score: 100 }] },
    { id: 17, type: 'integrity', question: 'Musíš se rozhodnout rychle, ale nemáš dostatek informací. Co uděláš?', options: [{ text: 'Počkám.', score: 10 }, { text: 'Rozhodnu se náhodně / intuitivně.', score: 20 }, { text: 'Udělám nejlepší odhad.', score: 60 }, { text: 'Rychle si získám klíčové minimum informací a rozhodnu se.', score: 100 }] },
    { id: 18, type: 'integrity', question: 'Dostaneš rutinní, nezajímavý úkol. Co uděláš?', options: [{ text: 'Odkládám ho.', score: 0 }, { text: 'Udělám minimum.', score: 30 }, { text: 'Udělám ho pořádně.', score: 70 }, { text: 'Najdu způsob, jak ho zlepšit nebo zefektivnit.', score: 100 }] },
    { id: 19, type: 'integrity', question: 'Máš informace, které by pomohly ostatním, ale nikdo si o ně neřekl. Co uděláš?', options: [{ text: 'Nechám si je pro sebe.', score: 0 }, { text: 'Řeknu to jen pokud se někdo zeptá.', score: 30 }, { text: 'Sdílím je.', score: 70 }, { text: 'Sdílím je strukturovaně tak, aby byly dlouhodobě použitelné.', score: 100 }] },
    { id: 20, type: 'integrity', question: 'Firma změní směr, se kterým nesouhlasíš. Co uděláš?', options: [{ text: 'Ztratím motivaci.', score: 0 }, { text: 'Udělám jen nutné minimum.', score: 20 }, { text: 'Přizpůsobím se.', score: 70 }, { text: 'Dám konstruktivní feedback a pak se plně přizpůsobím.', score: 100 }] }
  ],
  specific: {
    sales: [
