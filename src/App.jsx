...
const QUESTIONS = {
  iq: [
    { id: 1, type: 'iq', question: 'Doplňte chybějící prvek: A1, C3, F6, J10, ...?', options: ['L12', 'N14', 'O15', 'P16'], correct: 2 },
    { id: 2, type: 'iq', question: 'Zboží bylo zlevněno o 20 % a poté nová cena zvýšena o 25 %. Jaká je výsledná cena oproti původní?', options: ['Je o 5 % vyšší.', 'Je o 5 % nižší.', 'Je přesně stejná jako původní.', 'Je o 2 % nižší.'], correct: 2 },
    { id: 3, type: 'iq', question: 'Pokud slovo ALGORITMUS zakódujeme jako BMHPSJUMTU, jak zakódujeme slovo DATA?', options: ['EBUB', 'CZSZ', 'CBUB', 'EZSZ'], correct: 0 },
    { id: 4, type: 'iq', question: 'Pokud 4 stroje vyrobí 4 výrobky za 4 minuty, za kolik minut vyrobí 100 strojů 100 výrobků?', options: ['100 minut', '25 minut', '4 minuty', '1 minuta'], correct: 2 },
    { id: 5, type: 'iq', question: 'Doplňte řadu: 1, 1, 2, 3, 5, 8, 13, ...?', options: ['18', '20', '21', '25'], correct: 2 },
    { id: 6, type: 'iq', question: 'Které číslo logicky následuje v řadě: 2, 6, 18, 54, ...?', options: ['108', '162', '72', '216'], correct: 1 },
    { id: 7, type: 'iq', question: 'Všechny A jsou B. Žádné B není C. Platí tedy, že žádné A není C?', options: ['Ano, vždy platí.', 'Ne, neplatí.', 'Nelze určit.', 'Pouze někdy platí.'], correct: 0 },
    { id: 8, type: 'iq', question: 'Auto ujede 90 km za 1,5 hodiny. Jakou průměrnou rychlostí jelo?', options: ['45 km/h', '55 km/h', '60 km/h', '70 km/h'], correct: 2 },
    { id: 9, type: 'iq', question: 'Které slovo nepatří mezi ostatní?', options: ['Paříž', 'Londýn', 'Madrid', 'Evropa'], correct: 3 },
    { id: 10, type: 'iq', question: 'Graf ukazuje silnou korelaci mezi počtem prodaných zmrzlin a počtem požárů. Co z toho vyplývá?', options: ['Zmrzlina způsobuje požáry.', 'Požáry způsobují prodeje zmrzliny.', 'Existuje pravděpodobně třetí faktor ovlivňující obě proměnné.', 'Data jsou chybná.'], correct: 2 }
  ],
  personality: [
    ...
    { id: 9, type: 'big5', trait: 'neuroticism', inverted: true, question: 'Kritickou zpětnou vazbu na svou práci dokážu přijmout konstruktivně a využít ji ke zlepšení.' },
    ...
    { id: 11, type: 'big5', trait: 'neuroticism', inverted: true, question: 'Při důležitých rozhodnutích dokážu zachovat klid a nejprve si vše dobře promyslet.' },
    { id: 12, type: 'big5', trait: 'neuroticism', inverted: true, question: 'Dokážu zachovat klid a soustředění i při práci pod tlakem.' },
  ...
  psycho: [
    { id: 1, type: 'integrity', question: 'Všimneš si chyby v procesu, která zpomaluje celý tým. Není to tvoje odpovědnost a nikdo jiný to neřeší. Co uděláš?', options: [{ text: 'Začnu to aktivně řešit a dotáhnu změnu s ostatními.', score: 100 }, { text: 'Zmíním to nadřízenému a dál to neřeším.', score: 40 }, { text: 'Ignoruju to, není to moje role.', score: 0 }, { text: 'Navrhnu řešení a zkusím ho probrat s týmem.', score: 80 }] },
    { id: 2, type: 'integrity', question: 'Kolega opakovaně nedodává svou část práce včas, což ohrožuje projekt. Co uděláš?', options: [{ text: 'Otevřeně to s ním proberem a hledám řešení.', score: 80 }, { text: 'Udělám jeho práci za něj, aby byl klid.', score: 20 }, { text: 'Proberem to s ním a pokud se to nezlepší, zapojím vedoucího.', score: 100 }, { text: 'Postěžuji si ostatním kolegům.', score: 10 }] },
    { id: 3, type: 'integrity', question: 'Dostaneš kritický feedback na svou práci, se kterým nesouhlasíš. Co uděláš?', options: [{ text: 'Zamyslím se nad ním a vyžádám si konkrétní příklady.', score: 80 }, { text: 'Aktivně ho zapracuji a ověřím si zlepšení.', score: 100 }, { text: 'Vysvětlím, proč je špatný.', score: 20 }, { text: 'Ignoruju ho.', score: 0 }] },
    { id: 4, type: 'integrity', question: 'Manažer tě požádá, abys trochu upravil čísla, aby report vypadal lépe. Co uděláš?', options: [{ text: 'Udělám to, ale nejsem s tím v pohodě.', score: 10 }, { text: 'Odmítnu a navrhnu transparentní alternativu.', score: 100 }, { text: 'Udělám to, je to jeho odpovědnost.', score: 0 }, { text: 'Upozorním na problém a odmítnu.', score: 80 }] },
    { id: 5, type: 'integrity', question: 'Projekt, na kterém jsi pracoval týdny, se náhle ruší. Co uděláš?', options: [{ text: 'Přijmu to, ale bez většího zájmu.', score: 40 }, { text: 'Jsem frustrovaný/á a ztrácím motivaci.', score: 10 }, { text: 'Aktivně hledám, jak využít už odvedenou práci jinde.', score: 100 }, { text: 'Rychle se přeorientuji na nové zadání.', score: 80 }] },
    { id: 6, type: 'integrity', question: 'Vidíš, že rozhodnutí týmu směřuje špatným směrem, ale jsi v menšině. Co uděláš?', options: [{ text: 'Aktivně diskutuji a hledám nejlepší řešení s týmem.', score: 100 }, { text: 'Nic neřeknu.', score: 0 }, { text: 'Argumentuji svůj pohled.', score: 70 }, { text: 'Řeknu to jednou a dál to neřeším.', score: 40 }] },
    { id: 7, type: 'integrity', question: 'Zákazník si stěžuje na problém, který jsi nezpůsobil. Co uděláš?', options: [{ text: 'Vysvětlím, že to není moje chyba.', score: 20 }, { text: 'Vyřeším problém a hledám způsob, jak mu předejít.', score: 100 }, { text: 'Odkážu ho jinam.', score: 10 }, { text: 'Pomohu mu problém vyřešit.', score: 80 }] },
    { id: 8, type: 'integrity', question: 'Máš tři urgentní úkoly s podobným deadlinem. Co uděláš?', options: [{ text: 'Prioritizuji, komunikuji očekávání a případně přerozdělím práci.', score: 100 }, { text: 'Dělám je postupně, jak přišly.', score: 20 }, { text: 'Vyberu si ten nejjednodušší.', score: 10 }, { text: 'Prioritizuji podle dopadu.', score: 80 }] },
    { id: 9, type: 'integrity', question: 'Uděláš chybu, která způsobí problém v projektu. Co uděláš?', options: [{ text: 'Přiznám ji a opravím.', score: 80 }, { text: 'Snažím se ji skrýt.', score: 0 }, { text: 'Přiznám ji, opravím a nastavím prevenci do budoucna.', score: 100 }, { text: 'Přiznám ji, ale bez další akce.', score: 30 }] },
    { id: 10, type: 'integrity', question: 'Dostaneš úkol, který vyžaduje dovednost, kterou nemáš. Co uděláš?', options: [{ text: 'Zkusím to bez přípravy.', score: 20 }, { text: 'Aktivně se vzdělám a požádám o pomoc, abych to zvládl/a dobře.', score: 100 }, { text: 'Odmítnu ho.', score: 0 }, { text: 'Naučím se základy.', score: 70 }] },
    { id: 11, type: 'integrity', question: 'Blíží se deadline a víš, že pokud práci odevzdáš včas, bude obsahovat chyby. Co uděláš?', options: [{ text: 'Upozorním na riziko a navrhnu řešení.', score: 80 }, { text: 'Odevzdám to a chyby zmíním až potom.', score: 20 }, { text: 'Aktivně vyjednám prioritu mezi kvalitou a termínem a upravím plán.', score: 100 }, { text: 'Odevzdám to tak, jak to je.', score: 10 }] },
    { id: 12, type: 'integrity', question: 'Dostaneš úkol s velmi vágním zadáním. Co uděláš?', options: [{ text: 'Udělám to podle sebe bez ověření.', score: 20 }, { text: 'Navrhnu konkrétní směr a nechám si ho rychle potvrdit.', score: 100 }, { text: 'Počkám, až někdo upřesní zadání.', score: 10 }, { text: 'Doptám se na klíčové věci.', score: 80 }] },
    { id: 13, type: 'integrity', question: 'Vidíš, že jeden kolega dostává uznání za práci, na které ses významně podílel. Co uděláš?', options: [{ text: 'Postěžuji si kolegům.', score: 0 }, { text: 'Otevřu to konstruktivně a nastavím jasnější pravidla do budoucna.', score: 100 }, { text: 'Neřeším to.', score: 10 }, { text: 'Otevřu to s daným kolegou.', score: 70 }] },
    { id: 14, type: 'integrity', question: 'Tvůj nadřízený tě příliš kontroluje a zasahuje do detailů. Co uděláš?', options: [{ text: 'Omezím komunikaci na minimum.', score: 0 }, { text: 'Navrhnu konkrétní způsob spolupráce, který sníží potřebu kontroly.', score: 100 }, { text: 'Frustruje mě to, ale nic neřeknu.', score: 10 }, { text: 'Otevřeně to s ním proberem.', score: 70 }] },
    { id: 15, type: 'integrity', question: 'Kolega udělá chybu, která zatím není viditelná, ale může způsobit problém později. Co uděláš?', options: [{ text: 'Upozorním ho a pomohu nastavit prevenci.', score: 100 }, { text: 'Neřeším to.', score: 0 }, { text: 'Opravím to bez jeho vědomí.', score: 30 }, { text: 'Upozorním ho na to.', score: 70 }] },
    { id: 16, type: 'integrity', question: 'Máš víc práce, než je reálně zvládnutelné. Co uděláš?', options: [{ text: 'Vyberu si, co chci dělat.', score: 10 }, { text: 'Prioritizuji a něco odložím.', score: 70 }, { text: 'Pracuji déle a doufám, že to zvládnu.', score: 20 }, { text: 'Prioritizuji, komunikuji kapacitu a hledám řešení s týmem.', score: 100 }] },
    { id: 17, type: 'integrity', question: 'Musíš se rozhodnout rychle, ale nemáš dostatek informací. Co uděláš?', options: [{ text: 'Rychle si získám klíčové minimum informací a rozhodnu se.', score: 100 }, { text: 'Počkám.', score: 10 }, { text: 'Udělám nejlepší odhad.', score: 60 }, { text: 'Rozhodnu se náhodně / intuitivně.', score: 20 }] },
    { id: 18, type: 'integrity', question: 'Dostaneš rutinní, nezajímavý úkol. Co uděláš?', options: [{ text: 'Udělám ho pořádně.', score: 70 }, { text: 'Odkládám ho.', score: 0 }, { text: 'Najdu způsob, jak ho zlepšit nebo zefektivnit.', score: 100 }, { text: 'Udělám minimum.', score: 30 }] },
    { id: 19, type: 'integrity', question: 'Máš informace, které by pomohly ostatním, ale nikdo si o ně neřekl. Co uděláš?', options: [{ text: 'Nechám si je pro sebe.', score: 0 }, { text: 'Sdílím je strukturovaně tak, aby byly dlouhodobě použitelné.', score: 100 }, { text: 'Řeknu to jen pokud se někdo zeptá.', score: 30 }, { text: 'Sdílím je.', score: 70 }] },
...
const TestRunner = ({ roleId, onComplete, isNoSpecificRole }) => {
  ...
  const calculateAndComplete = (finalAnswers) => {
    ...
    // Q1-8: výběr ze 4 možností s likertValues [1-4]
    // Q9-15: škála 1-5, některé označeny inverted=true (vysoké skóre = nízký neuroticismus)
    ...
    QUESTIONS.personality.forEach((q, idx) => {
      ...
      if (q.likertValues) {
        // Q1-8: hodnota z likertValues [1-4], normalizuj na 0-100
        ...
        normalizedVal = Math.round(((raw - 1) / 3) * 100);
      } else {
        // Q9-15: škála 1-5
        const raw = finalAnswers.personality[idx] || 3;
        if (q.inverted) {
          // Invertované otázky: vysoké skóre = pozitivní (nízký neuroticismus)
          // Proto invertujeme: 5->0, 4->25, 3->50, 2->75, 1->100 (z pohledu neuroticism)
          normalizedVal = Math.round(((5 - raw) / 4) * 100);
        } else {
          normalizedVal = Math.round(((raw - 1) / 4) * 100);
        }
      }
